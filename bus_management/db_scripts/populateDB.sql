...
INSERT INTO main.location (address, category_id, is_station) VALUES
  ('Rua A, 123', (SELECT id FROM main.transport_category WHERE name = 'Ônibus'), true),
...
INSERT INTO main.route (name, location_start_id, location_destiny_id, distance) VALUES
  ('Rota A', (SELECT id FROM main.location WHERE address = 'Rua A, 123'), (SELECT id FROM main.location WHERE address = 'Estação Central'), 10),
...
INSERT INTO main.vehicle (category_id, manufacturer, model, year, capacity) VALUES
  ...
  ((SELECT id FROM main.transport_category WHERE name = 'Metrô'), 'MetroTrain', 'Modelo M', 2023, 300);
...
INSERT INTO main.vehicle_route (vehicle_id, route_id, time_init, time_end) VALUES
  ...
  ((SELECT id FROM main.vehicle WHERE manufacturer = 'MetroTrain'), (SELECT id FROM main.route WHERE name = 'Rota E'), '18:00:00', '18:30:00');
...
INSERT INTO main.transportation (date, passenger_id, vehicle_id) VALUES
  ...
  ('2023-06-05', (SELECT id FROM main.passenger WHERE name = 'Carlos Souza'), (SELECT id FROM main.vehicle WHERE manufacturer = 'MetroTrain'));
...
INSERT INTO main.feedback (passenger_id, comment, rating) VALUES
  ...
  ((SELECT id FROM main.passenger WHERE name = 'Carlos Souza'), 'Muito confortável.', 5);
